...
\newcommand{\cosupervisorname}{Afonso Eloy}	% Your co-supervisor's name, if any.
...
\chapter{Statistical Background}	% One chapter per appendix
\label{app: statistics}
\input{appendix/statistics.tex}
